  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <div v-else>
      ...
      <div class="max-w-7xl mx-auto px-4 -mt-64 relative z-10">
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="flex-1 text-white">
            ...
            <div class="bg-white rounded-2xl p-2">
              <h2 class="text-2xl font-semibold text-black">Overview</h2>
        ...
        <div
          v-if="cast.length > 0"
          class="mt-12 bg-white rounded-lg p-6 shadow-lg"
        >
          <h2 class="text-3xl font-bold text-gray-800 mb-6">Cast</h2>
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6">
            <div v-for="person in cast" :key="person.id" class="text-center">
              <img
              ...
              <div
                v-else
                class="w-full h-40 bg-gray-300 rounded-lg mb-2 flex items-center justify-center"
              >
